...
- [ ] 2. docs/USAGE.md を作成（詳細利用ガイド）
  - [ ] 2.1 フォルダ配置規約と参照取り込み手順を記述
  ...
  - [ ] 2.2 ホスト登録・DB 準備・導線登録・動作確認・トラブルシュートを記述
...
- [ ] 3. docs/README.md に SQL 索引・適用順を追記
...
- [ ] 4. CONTRIBUTING.md を作成（ブランチ・貢献運用）
